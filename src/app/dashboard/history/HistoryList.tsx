...
export default function HistoryList({ sales }: { sales: any[] }) {
        ...
        <table className="min-w-full divide-y divide-slate-800">
          <thead className="bg-slate-900/50">
            <tr>
              ...
              <th className="px-6 py-4 text-left text-xs font-medium text-slate-400 uppercase tracking-wider">Commission</th>
            </tr>
          </thead>
